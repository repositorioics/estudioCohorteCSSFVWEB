...
public class ExportarListBox {
	...
	public static void export_to_csv_con_fechas(Listbox listbox, String [] metodos, Object[] lista, String nombreArchivo, String titulo, Date fechaInicio, Date fechaFin) throws Exception {
        String s = ",";
        StringBuffer sb = new StringBuffer();
        String l = "\n";

        SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
        String dateString = format.format(fechaInicio);
        String dateString2 = format.format(fechaFin);
        
        
        sb.append(titulo + l);
        sb.append(l);
        sb.append("Total Médicos: " + lista.length + "\n");
        sb.append("Fecha Inicio: " + dateString + " " + " " + "Fecha Fin: " + dateString2 + "\n");
        sb.append(l);
